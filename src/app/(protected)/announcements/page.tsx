      ...
      <div className="space-y-4">
        {validData.length === 0 ? (
          ...
          validData.map((announcement) => {
            ...
            if (announcement.title.includes("v1.0.0") || announcement.title.includes("v1.1.0") || announcement.title.includes("v1.1.5") || announcement.title.includes("v1.1.6") || announcement.title.includes("v1.1.7") || announcement.title.includes("v1.1.8") || announcement.category === "update") href = "/updates";
